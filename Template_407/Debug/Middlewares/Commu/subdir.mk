...
C_SRCS += \
../Middlewares/Commu/uart_commu.c 

OBJS += \
./Middlewares/Commu/uart_commu.o 

C_DEPS += \
./Middlewares/Commu/uart_commu.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Commu/%.o Middlewares/Commu/%.su: ../Middlewares/Commu/%.c Middlewares/Commu/subdir.mk
...
clean: clean-Middlewares-2f-Commu

clean-Middlewares-2f-Commu:
	-$(RM) ./Middlewares/Commu/uart_commu.d ./Middlewares/Commu/uart_commu.o ./Middlewares/Commu/uart_commu.su

.PHONY: clean-Middlewares-2f-Commu
